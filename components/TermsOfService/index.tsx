  ...
  return (
    <section className="pb-[120px] pt-[40px]">
      <div className="container">
        <h2 className="text-title-paragraph mb-3 mt-3 flex items-center">
        ...
        <p className="text-paragraph">
          We are LNH INFOTECH PRIVATE LIMITED ('Company', 'we', 'us', or 'our'),
          a company registered in India at A- 1107, PNTC, VEJALPUR, Jodhpur Char
          Rasta, Ahmadabad City, Ahmedabad- 380015, Gujarat.
        </p>
        <p className="text-paragraph">
          We operate the website{" "}
          <a className="text-primary" href="https://hellofy.io/">
            https://www.hellofy.io
          </a>{" "}
          (the 'Site'), the mobile application Hellofy (the 'App'), as well as
          any other related products and services that refer or link to these
          legal terms (the 'Legal Terms') (collectively, the 'Services').
        </p>
        <p className="text-paragraph">
          You can contact us by phone at +91 9998700982, email at{" "}
          <a className="text-primary" href="mailto:support@hellofy.io">
            support@hellofy.io
          </a>
          , or by mail to A- 1107, PNTC, VEJALPUR, Jodhpur Char Rasta, Ahmadabad
          City, Ahmedabad- 380015, Gujarat, India.
        </p>
        <p className="text-paragraph">
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ('you'), and LNH
          INFOTECH PRIVATE LIMITED, concerning your access to and use of the
        ...
        <p className="text-paragraph">Our intellectual property</p>
        <p className="text-paragraph">
        ...
        <p className="text-paragraph">Your use of our Services</p>
        <p className="text-paragraph">
          Subject to your compliance with these Legal Terms, including the
          'PROHIBITED ACTIVITIES' section below, we grant you a non-exclusive,
          non-transferable, revocable licence to: <br />
        ...
        <p className="text-paragraph">Your submissions and contributions</p>
        <p className="text-paragraph">
        ...
        <p className="text-paragraph">
          ...
          false, inaccurate, deceitful, or misleading; <br />
          to the extent permissible by applicable law, waive any and all moral
          rights to any such Submission and/or Contribution; <br />
          ...
          and/or Contributions; and <br />
          warrant and represent that your Submissions and/or Contributions do
          not constitute confidential information. <br />
        ...
        <p className="text-paragraph">
          All the payments related to messages will be paid directly to Meta.
          And regarding the usage of the portal to send or receive messages or
          any service available in the portal will be charged separately, these
          charges will be handled outside the portal for now.&nbsp;
        </p>
        <h1 className="text-title-paragraph mb-3 mt-3 flex items-center">
          6{" "}
          <span className="ml-1 mr-3 block h-2 w-2 rotate-45 border-r-2 border-t-2 border-black"></span>{" "}
        ...
        <p className="text-paragraph">Fee Changes</p>
        <p className="text-paragraph">
        ...
        <p className="text-paragraph">
          ...
          the Services and/or the Content contained therein. <br />
          Disparage, tarnish, or otherwise harm, in our opinion, us and/or the
          Services. <br />
          Use any information obtained from the Services in order to harass,
          abuse, or harm another person. <br />
          Make improper use of our support services or submit false reports of
          abuse or misconduct. <br />
          ...
          the networks or services connected to the Services. <br />
          ...
          accounts by automated means or under false pretences. <br />
        ...
        <p className="text-paragraph">
          ...
          secret, or moral rights of any third party. <br />
          ...
          contemplated by the Services and these Legal Terms. <br />
          ...
          a specific person or class of people. <br />
        ...
        <p className="text-paragraph">Use Licence</p>
        <p className="text-paragraph">
        ...
        <p className="text-paragraph">Apple and Android Devices</p>
        <p className="text-paragraph">
          ...
          the Services: (1) the licence granted to you for our App is limited to
          a non-transferable licence to use the application on a device that
        ...
        <p className="text-paragraph">
          ...
          Policy:{" "}
          <a
            href="https://www.hellofy.io/privacy-policy"
            className="text-primary"
          >
            https://www.hellofy.io/privacy-policy
          </a>{" "}
        ...
        <p className="text-paragraph">
          ...
          of India. LNH INFOTECH PRIVATE LIMITED and yourself irrevocably
        ...
        <p className="text-paragraph">
          <strong>LNH INFOTECH PRIVATE LIMITED</strong> <br />
          A- 1107, PNTC,VEJALPUR <br />
          Jodhpur Char Rasta, Ahmadabad City <br />
          Ahmedabad, Gujarat 380015 <br />
          India <br />
          <strong>Phone:</strong> +91 9998700982 <br />
          <a href="mailto:support@hellofy.io" className="text-primary">
            support@hellofy.io
          </a>
        </p>
